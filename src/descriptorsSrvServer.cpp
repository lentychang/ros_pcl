...
// rosservice call /descriptorSrvServer "{keypntType: 'iss', getPfh: true, getFpfh: true, getVfh: true, getRsd: true,
// getSc3d: true,   getUsc: true, getShot: true, filename: 'scene', inputCloudDir: '/root/exchange/tempData/filtered',
// inputKeypntsDir: '/root/exchange/tempData/detector',  outputDir: '/root/exchange/tempData/descriptor'}"
